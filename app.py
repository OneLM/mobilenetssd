...
lineaccesstoken = 'NI5SKTnzTHhFI0DZ3jk2kxmn/5rbdtrynubA8w4wP1cfiZ5ttjdOpYZ8vQnnSTHzZvV8qrr/5+jzMhbpsFuXRupNHNLf8UslC8AyxbF4Oyst/4mZILEVfUkAPSMTBXBl61fVeNXUHoKLxKSdDWI2AQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "หวัดดี") :
            replyObj = TextSendMessage(text="เห้อ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "กินข้าวยัง") :
            replyObj = TextSendMessage(text="ยังไม่กิน")
            line_bot_api.reply_message(rtoken, replyObj)
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/0999d5b6-981b-4764-a3d5-534fbb47f334"
